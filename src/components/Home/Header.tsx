    ...
    <div className="relative w-full h-200 flex flex-col md:flex-row px-5 md:px-17 lg:px-40 xl:px-50 2xl:px-30 2xl:py-70 py-35 md:py-45 sm:py-45 min-h-screen">
      ...
      <div className="relative w-full text-center 2xl:pr-30">
        ...
        <div className="mt-5 sm:mt-6 md:mt-10 flex sm:flex-row gap-3 sm:gap-5 justify-center">
          <button
            onClick={() => navigate("")}
            className="bg-[#A86A28]/[0.7] hover:bg-[#A86A28]/40 text-white border-3 border-[#A9A9A8] px-5 sm:px-4 2xl:px-15 2xl:p-2 md:px-4 py-2 rounded-xl shadow-md transition duration-300 text-md 2xl:text-xl xl:text-md sm:text-lg w-auto max-w-fit whitespace-nowrap cursor-pointer"
          >
            School Admission
          </button>
          <button
            onClick={() => navigate("")}
            className="bg-[#A86A28]/[0.7] hover:bg-[#A86A28]/40 text-white border-3 border-[#A9A9A8] px-5 sm:px-4 2xl:px-15 2xl:p-2 md:px-4 py-2 rounded-xl shadow-md transition duration-300 text-md 2xl:text-xl xl:text-md sm:text-lg w-auto max-w-fit cursor-pointer whitespace-nowrap"
          >
            Learner Admission
          </button>
        </div>
        <div className="mt-4 sm:mt-6 flex justify-center">
          <button
            onClick={() => navigate("")}
            className="bg-[#A86A28]/[0.7] hover:bg-[#A86A28]/40 text-white border-3 border-[#A9A9A8] 2xl:mt-4 px-25 2xl:px-52 xl:px-25 lg:px-25 md:px-25 sm:px-25 2xl:p-2 py-2 rounded-xl shadow-md transition duration-300 text-md xl:text-md sm:text-xl w-auto max-w-fit cursor-pointer whitespace-nowrap"
          >
        ...
        <div className="relative mt-6 sm:mt-4 xl:hidden text-center">
          ...
          <div className="mt-3 sm:mt-4 flex justify-center">
            <button
              onClick={() => navigate("")}
              className="bg-[#A86A28] hover:bg-[#A86A28]/60 text-white border-6 border-[#A9A9A8] px-31 sm:px-40 md:px-35 lg:px-35 py-2 rounded-lg shadow-md transition duration-300 font-semibold text-lg sm:text-lg w-auto max-w-fit cursor-pointer text-nowrap"
            >
              START NOW
            </button>
          </div>
      ...
      <div className="relative hidden xl:block text-center mt-6 sm:mt-4 2xl:mt-7 xl:mt-5 lg:mt-3 pl-5 md:pl-5 lg:pl-10 xl:pl-23 2xl:pl-0">
        ...
        <div className="mt-3 2xl:mt-7 sm:mt-4 flex justify-center">
          <button
            onClick={() => navigate("")}
            className="bg-[#A86A28] hover:bg-[#A86A28]/60 text-white border-6 border-[#A9A9A8] px-6 sm:px-10 2xl:px-60 2xl:py-2 xl:px-40 lg:px-16 py-2 rounded-lg shadow-md transition duration-300 font-bold text-sm 2xl:text-xl sm:text-lg w-full sm:w-auto cursor-pointer text-nowrap"
          >
            START NOW
          </button>
        </div>
